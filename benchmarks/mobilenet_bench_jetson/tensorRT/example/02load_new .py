...
with open("/home/deep/Documents/benchmark_thesis/benchmarks/mobilenet_bench_jetson_tensorRT_noOK/example/saved_model/saved_model.pb", 'rb') as f:
    graph_def.ParseFromString(f.read())

with tf.Graph().as_default() as graph:
    tf.import_graph_def(graph_def, name='graph_mobilenet')
