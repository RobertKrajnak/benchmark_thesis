...
interpreter = tflite.Interpreter(
    model_path="../default_efficientdet_models_and_labels/efficientdet_lite1_model.tflite",
...
with open("print_out_loadDeleegate_efficientdet_batch"+str(batch_size)+"_nrun"+str(N_run)+".txt", 'w') as f:
    sys.stdout = f
