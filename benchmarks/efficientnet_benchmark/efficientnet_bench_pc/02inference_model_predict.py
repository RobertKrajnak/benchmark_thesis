...
model = tf.keras.models.load_model('../default_efficientnet_models_and_labels/efficientnetb0_saved_model')
...
with open("print_out_modelPredict_efficientnet_batch"+str(batch_size)+"_topk"+str(k)+"_nrun"+str(N_run)+".txt", 'w') as f:
    sys.stdout = f
