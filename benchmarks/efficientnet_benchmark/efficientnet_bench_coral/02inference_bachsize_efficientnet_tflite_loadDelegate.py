...
# Windows: edgetpu.dll
interpreter = tflite.Interpreter("../default_efficientnet_models_and_labels/efficientnetb0_model_FP16.tflite",
...
with open("print_out_loadDelegate_efficientnet_batch"+str(batch_size)+"_topk"+str(k)+"_nrun"+str(N_run)+".txt", 'w') as f:
    sys.stdout = f
