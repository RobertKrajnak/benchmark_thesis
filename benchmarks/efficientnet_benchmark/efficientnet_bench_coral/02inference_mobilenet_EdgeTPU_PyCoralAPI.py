...
model_file = os.path.join(script_dir, "../default_efficientnet_models_and_labels/efficientnetb0_model_FP16.tflite")
...
label_file = os.path.join(script_dir, '../default_efficientnet_models_and_labels/imagenet_labels.txt')
