...
input_saved_model = "../default_mobilenet_models_and_labels/mobilenet_v2_saved_model_TFTRT_FP16"
...
with open("print_out_tftrt_mobilenet_batch"+str(batch_size)+"_topk"+str(k)+"_nrun"+str(N_run)+".txt", 'w') as f:
    sys.stdout = f
