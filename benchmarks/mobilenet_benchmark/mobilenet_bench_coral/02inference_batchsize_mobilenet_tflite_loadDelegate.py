...
# Windows: edgetpu.dll
interpreter = tflite.Interpreter("../default_mobilenet_models_and_labels/mobilenetv2_model_FP16.tflite",
...
with open("print_out_loadDelegate_mobilenet_batch"+str(batch_size)+"_topk"+str(k)+"_nrun"+str(N_run)+".txt", 'w') as f:
    sys.stdout = f
