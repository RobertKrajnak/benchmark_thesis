...
interpreter = tf.lite.Interpreter("../default_resnet_models_and_labels/resnet50_model_FP16.tflite")
...
with open("print_out_tf.lite_resnet_batch"+str(batch_size)+"_topk"+str(k)+"_nrun"+str(N_run)+".txt", 'w') as f:
    sys.stdout = f
