...
model_file = os.path.join(script_dir, '../default_resnet_models_and_labels/resnet50_model.tflite')
...
label_file = os.path.join(script_dir, '../default_resnet_models_and_labels/imagenet_labels.txt')
...
with open('print_out_resnet50_PyCoralAPI.txt', 'w') as f:
    sys.stdout = f
