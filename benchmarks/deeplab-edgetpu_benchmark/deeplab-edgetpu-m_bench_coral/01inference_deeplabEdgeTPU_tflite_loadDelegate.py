...
interpreter = tflite.Interpreter("../default_deeplab-edgetpu_models_and_labels/deeplab-edgetpu_m_model.tflite",
...
with open("print_out_loadDelegate_deeplab_batch"+str(batch_size)+"_nrun"+str(N_run)+".txt", 'w') as f:
    sys.stdout = f
