...
filename = os.path.join(script_dir, 'n01443537_11099_goldfish.jpg')
model_path = os.path.join(script_dir, 'model.tflite')
label_path = os.path.join(script_dir, 'imagenet1000_clsidx_to_labels.txt')
top_k_results = 3
...
for i in range(top_k_results):
    print(labels[top_k_indices[i]], predictions[top_k_indices[i]])