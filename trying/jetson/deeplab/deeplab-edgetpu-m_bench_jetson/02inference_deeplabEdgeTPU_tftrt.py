# https://tfhub.dev/google/edgetpu/vision/deeplab-edgetpu/default_argmax/m/1
...
input_saved_model = "../default_deeplab-edgetpu_models_and_labels/deeplab-edgetpu_m_saved_model_TFTRT_FP16"
...
batched_input = np.zeros((batch_size, 512, 512, 3), dtype=np.int8)
...
with open('print_out_deeplab_tftrt.txt', 'w') as f:
    sys.stdout = f
